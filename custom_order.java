...
public class custom_order {
  ...
  double tax; //Amount of tax
    ...
    System.out.println("Welcome to Harry's Cake & Cupcake Shop");
    System.out.println("We make custom cakes with our secret cake batter!");

	  
	  
    // TEST CODE
     //On this test everything was nice

    // STEP 3 INPUT YOUR NAME AND PREPARE TO VIEW MENU
    System.out.print("What is your good name Sir? ");
    firstName = scn.nextLine();

    System.out.print(firstName + ", Here is the menu Sir.");
    System.out.print("\n");
   ...
   System.out.printf("It was nice seeing you"+" "+firstName);
   System.out.println();
